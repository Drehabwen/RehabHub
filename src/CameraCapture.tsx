...
const CameraCapture: React.FC<CameraCaptureProps> = ({ 
  ...
  return (
    <div className="w-full p-4">
      {/* 摄像头预览区域 - 移动端优化，增大预览尺寸 */}
      <div className="relative bg-black rounded-xl overflow-hidden mb-6 shadow-lg border border-gray-200 transition-all hover:shadow-xl w-full" style={{minHeight: '70vh'}}>
        {status === 'loading' && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-900">
            <div className="text-white text-center space-y-4 p-4">
              <div className="relative">
                <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-indigo-400 mx-auto"></div>
                <div className="animate-ping absolute inset-0 rounded-full h-16 w-16 bg-indigo-500 opacity-20 mx-auto"></div>
              </div>
